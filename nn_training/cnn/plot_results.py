...
def parse_args():
    default_run_dir = DEFAULT_RUNS_DIR / "symbols_cnn"
    parser = argparse.ArgumentParser(description="Plot CNN train, validation, and test results.")
...
def plot_results(paths: Dict[str, Path]) -> None:
    ...
    fig.suptitle("Symbol CNN Training Results", fontsize=18)
