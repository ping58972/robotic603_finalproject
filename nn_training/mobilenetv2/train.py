...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train MobileNetV2 for symbol image classification.")
    ...
    parser.add_argument("--pretrained", action="store_true", help="Initialize from ImageNet MobileNetV2 weights.")
    parser.add_argument("--freeze-features", action="store_true", help="Train only the classifier head.")
